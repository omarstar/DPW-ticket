            ...
            {/* <div className=""> */}
                ...
                <div class="d-flex flex-column justify-content-center align-items-center bg-white">
                    <div class="header-section">
                        <img id="header-home-btn"  src={homeCircleImg} alt="" class="header-homecircle-img" />
                    ...
                    <div id="transparentmodal-exithome" class="transparent-bg flex-column w-100">
                        ...
                        <div class="modal-btns-box d-flex flex-column justify-content-around">
                            <button id="btn-yes-modal" class="button-wide button-outline-clr space-btnmodal-yes">Yes</button>
                            <button id="btn-no-modal" class="button-wide button-outline-clr  space-btnmodal-no">No</button>
                            <button id="btn-proceed-modal" class="button-wide button-outline-clr  space-btnmodal-proceed">Proceed on your mobile</button>
                        </div>
                    </div>
                </div>
                {/* <Footer /> */}
